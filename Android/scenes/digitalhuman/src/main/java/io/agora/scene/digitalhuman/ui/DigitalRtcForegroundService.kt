...
class DigitalRtcForegroundService : Service() {

    private val TAG = "DigitalRtcForegroundService"
    private val CHANNEL_ID = "DigitalRtcForegroundServiceChannel"
    ...
    private fun createNotification(): Notification {
        val notificationIntent = Intent(this, DigitalLivingActivity::class.java)
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle(getString(R.string.digital_detail_agent_title))
            .setContentText("Audio recording in background")
            .setSmallIcon(io.agora.scene.common.R.mipmap.ic_launcher)
