Pod::Spec.new do |s| 
   ...
   s.platform      = :ios,9.0 
   s.source        = { :http => 'https://download.agora.io/sdk/release/AgoraRtm-2.2.3.zip'}
   ...
   s.prepare_command = <<-CMD
      ...
      curl -L -o RTMLibs/resource.zip https://download.agora.io/sdk/release/AgoraRtm-2.2.3.zip
